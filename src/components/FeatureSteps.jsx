    ...
    <div className="bg-zinc-700/[0.15] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-zinc-100 sm:text-4xl">Khiến bạn khó hiểu.</p>
        ...
        {features.map((feature) => (
          <div key={feature.name} className="relative pl-9">
            <dt className="inline font-semibold text-yellow-500">
                <feature.icon className="absolute left-1 top-1 h-6 w-6 text-yellow-500" aria-hidden="true" />
                {feature.name}
            </dt>{' '}
